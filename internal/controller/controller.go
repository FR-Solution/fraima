...
func (s *controller) generation(wg *sync.WaitGroup, fileType string, instruction config.Instruction) {
	defer wg.Done()
	zap.L().Info("generation", zap.String("step", "start"), zap.Any("apiVersion", instruction.Metadata.APIVersion), zap.Any("kind", instruction.Metadata.Kind), zap.String("type", fileType))
	...
	zap.L().Info("generation", zap.String("step", "finish"), zap.Any("apiVersion", instruction.Metadata.APIVersion), zap.Any("kind", instruction.Metadata.Kind), zap.String("type", fileType))
}
